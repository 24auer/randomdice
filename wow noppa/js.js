...
if (leftDice > rightDice) {
    document.querySelector(".bigText").innerHTML = "Player 1 Wins!";
} else if (rightDice > leftDice) {
    document.querySelector(".bigText").innerHTML = "Player 2 Wins!";
} else if (rightDice === leftDice) {
    document.querySelector(".bigText").innerHTML = "Draw!";
}
